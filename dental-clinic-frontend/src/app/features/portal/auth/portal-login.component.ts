...
@Component({
  ...
  styles: [`
    ...
    .auth-subtitle {
      font-size: 0.85rem; color: var(--gray-500); margin-bottom: 32px;
    }
  ...
  template: `
    <div class="auth-page">
      <div class="auth-card">
        ...
        <p class="auth-subtitle">Sign in to your patient account</p>
        ...
        <div class="auth-footer">
          Don't have an account? <a routerLink="/portal/register">Create one</a>
        </div>
      </div>
    </div>
  `
