...
export class TranslationService {
  ...
  private enTranslations: { [key: string]: any } = {
    ...
    treatmentRecords: {
      ...
      toothSurface: "Tooth Surface(s)",
      selectTooth: "Select Tooth",
      selectSurface: "Select Surface(s)",
      selectDiagnosis: "Select Diagnosis",
      selectProcedure: "Select Procedure",
      selectAnaesthesia: "Select Anaesthesia",
      selectMaterial: "Select Material",
      anaesthesiaType: "Anaesthesia Type",
      injectionTechnique: "Injection Technique",
      carpules: "Carpules",
  ...
  private arTranslations: { [key: string]: any } = {
    ...
    treatmentRecords: {
      ...
      extraoralFindings: "النتائج خارج الفم",
      intraoralFindings: "النتائج داخل الفم",
      teethCondition: "حالة الأسنان",
      gumCondition: "حالة اللثة",
      radiographicFindings: "النتائج الإشعاعية (أشعة)",
      diagnosis: "التشخيص",
      ...
      toothSurface: "سطح السن",
      selectTooth: "اختر السن",
      selectSurface: "اختر السطح",
      selectDiagnosis: "اختر التشخيص",
      selectProcedure: "اختر الإجراء",
      selectAnaesthesia: "اختر التخدير",
      selectMaterial: "اختر المادة",
      anaesthesiaType: "نوع التخدير",
      injectionTechnique: "تقنية الحقن",
      carpules: "الكبسولات",
      treatmentArea: "منطقة العلاج",
      priority: "الأولوية",
      urgent: "عاجل",
      high: "عالية",
      medium: "متوسطة",
